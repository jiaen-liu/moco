...
handles.isplot1 = 0;
handles.zoom_state = [];
set( handles.auto_contrast, 'Value', 0);
...
if handles.max_scaling == handles.min_scaling
    if handles.max_scaling == 0
        handles.max_scaling = 1;
    else
        handles.max_scaling = 1.1*handles.max_scaling;
    end
end
...
set( handles.slider1, 'Position', ...
    [5, y_slider+1, guipos(3)-10, sliderpos(4)] );
...
colormap( handles.axes1, handles.cm );
...
handles.max_scaling = pos_Max*handles.max_img_value;
